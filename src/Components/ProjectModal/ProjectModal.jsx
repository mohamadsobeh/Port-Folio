              ...
              <div>
                ...
                <ul className="space-y-2 sm:space-y-3">
                  {project.features.map((feature, i) => (
                    <li
                      key={i}
                      className="flex items-start p-2 sm:p-3 bg-gray-50 rounded-lg shadow-sm hover:bg-gray-100 transition-all"
                    >
              ...
              <div>
                ...
                <ul className="space-y-2 sm:space-y-3">
                  {project.challenges.map((challenge, i) => (
                    <li
                      key={i}
                      className="p-2 sm:p-4 bg-gray-50 rounded-lg shadow-sm hover:bg-gray-100 transition-all"
                    >
