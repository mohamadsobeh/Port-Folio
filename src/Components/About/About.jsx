...
import photo from "../../assets/images/mohamd.jpg";
          ...
          <motion.div variants={textItem} className="lg:w-2/3 space-y-8">
            <div className="space-y-6">
              <p className="text-xl leading-relaxed text-neutral-700">
                ...
                I’m Mohamad Sobeh, a{" "}
                <span className="font-bold text-dark-800">Palestinian</span>{" "}
                living in Damascus, Syria. As a self-taught{" "}
                <span className="font-bold text-dark-800">Front End Developer</span>
                , I bring over 2 years of experience creating responsive,
                interactive, and user-friendly web applications.
              </p>

              <p className="text-lg text-neutral-600">
                My journey in tech started with a passion for problem-solving,
                evolving through countless hours of self-learning. I’ve honed my
                skills in{" "}
                ...
                from the University of Damascus.
              </p>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-neutral-700">
                      Freelancing since 2023, delivering 10+ projects with 95%
                      client satisfaction
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary-500 mr-2">✓</span>
                    <span className="text-neutral-700">
                      Reduced development time by 30% with reusable React
                      components
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary-500 mr-2">✓</span>
                    <span className="text-neutral-700">
                      Built responsive designs optimized for all devices using
                      Tailwind CSS
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-6 bg-white rounded-xl shadow-lg border border-neutral-100">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <span className="text-primary-500 mr-2">✓</span>
                    <span className="text-neutral-700">
                      Collaborating to bring creative visions to life
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary-500 mr-2">✓</span>
