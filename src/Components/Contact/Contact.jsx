...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact | Mohamad Sobeh</title>
        <meta
          name="description"
          content="Get in touch with Mohamad Sobeh for collaborations or inquiries."
        />
      </Helmet>

      <section
        id="contact"
        className="py-28 px-4 sm:px-6 lg:px-8 bg-dark-900 text-white relative overflow-hidden"
      >
            ...
            >
              <div>
                ...
                <div className="space-y-4">
                  <a
                    href="mohammadsobh1999@gmail.com"
                    className="flex items-center gap-4 text-neutral-300 hover:text-primary-400 transition-colors"
                  >
                    <div className="w-12 h-12 rounded-full bg-dark-800 flex items-center justify-center">
                      <FiMail className="text-xl" />
                    </div>
                    <span>mohammadsobh1999@gmail.com</span>
                  </a>
