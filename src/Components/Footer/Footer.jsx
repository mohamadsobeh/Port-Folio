...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: SiVercel, href: 'https://vercel.com/mohamadsobehs-projects', label: 'Vercel' },
    { icon: FaLinkedin, href: 'https://www.linkedin.com/in/mohamad-sobeh-59b486277/', label: 'LinkedIn' },
  ];
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <a href="mailto:mohammadsobh1999@gmail.com" className="text-neutral-400 hover:text-primary-400 transition-colors">
              ...
              >
                ...
                <span className="text-neutral-400">+963 959837527</span>
              </motion.li>
            </ul>
          </motion.div>
        </div>
